...
// màu sắc 4 đỉnh
const vec3 colorsRGB[4] = vec3[](
    mau_do, mau_xanh_duong, mau_vang, mau_tim
);
...
void main()
{
    gl_Position = projection * world * vec4(positions[gl_VertexIndex], 0.0f, 1.0f);
    fragColor = colorsRGB[gl_VertexIndex % 4];
}
