...
void Application::createImmutableSampler()
{
    ...
    vkfunc(result, "Loi: tao immutable sampler khong thanh cong!",
        vkCreateSampler(device, &samplerInfo, nullptr, &immutableSampler)
    );

    std::cout << "Tao immutable sampler thanh cong.\n";
}
...
void Application::createDescriptorSetLayout()
{
    ...
    bindings[BIND_ID_TEXTURE].pImmutableSamplers = &immutableSampler;
